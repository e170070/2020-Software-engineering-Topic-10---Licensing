...
import com.personal.utils.UserHolder;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http    /*匿名请求：不需要进行登录拦截的url*/
                .authorizeRequests()
                    .antMatchers("/","/getVerifyCode","/login_page","/static/**","/register","/registeruser","/license","/updatelicense","/shop","/buylicense/**","/updatelicense","/sale","/goshop/**").permitAll()
...
//                out.close();
                ...
                if("用戶license过期".equals(e.getMessage())){
                    httpServletRequest.setAttribute("msg",e.getMessage());
                    httpServletRequest.getRequestDispatcher("license").forward(httpServletRequest,httpServletResponse);
                }else {
                    httpServletRequest.setAttribute("msg",e.getMessage());
